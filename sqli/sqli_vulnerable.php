...
<?php
    ...
    try {
        $query = "SELECT * FROM accounts A INNER JOIN users B ON A.id_users = B.id WHERE login = '" . $_POST["login"] . "' AND pass = '" . $_POST["password"] . "'";
        echo $query;
        ...
        echo '<table border="1">';
        echo '<tr><th>Id</th><th>Type compte</th><th>Montant</th></tr>';
